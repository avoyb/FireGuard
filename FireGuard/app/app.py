...
# CSS style can be added within the app.py file itself
st.markdown('''
    <style>
        body {
...
if uploaded_file is not None:
    ...
    with st.spinner("Pre-processing the image..."):
        ...
        st.sidebar.success("Pre-processing completed!")
    ...
    st.sidebar.text("{0:.2f}".format(equal_days) + " days of California's daily electricity power emission")